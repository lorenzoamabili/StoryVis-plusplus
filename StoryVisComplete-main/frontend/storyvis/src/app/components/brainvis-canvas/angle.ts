...
export default class Angle {
  ...
  constructor(renderer: Renderer2D, evt: MouseEvent | null = null) {
    ...
    // this.settings.loadedData ? '' : 'DOUBLE CLICK HERE to create an annotation';
  ...
  onMouseUp = (evt) => {
    ...
    //     p2: this.widget._handles[2].worldPosition,
    //   });
    // } else {
    //   this.changed.emit({
    //     oldPoints: {
    ...
    //       p2: this.widget._handles[2].worldPosition.clone(),
