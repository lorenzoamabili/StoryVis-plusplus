import { StateNode, Action, IProvenanceTracker, IActionFunctionRegistry, IProvenanceGraph, ProvenanceNode, IScreenShotProvider, SerializedProvenanceGraph, Artifact } from './api';
/**
...
export declare class ProvenanceTracker implements IProvenanceTracker {
     ...
     */
    applyAction(action: Action, skipFirstDoFunctionCall?: boolean, artifacts?: Artifact | Artifact[], option?: string, newRoot?: ProvenanceNode): Promise<StateNode>;
